  ...
  const faqs = [
    {
      ...
      a: 'โต๊ะจีน รพีพัฒน์ พรีเมียม รับจัดเลี้ยงเริ่มต้นตั้งแต่ 10 โต๊ะขึ้นไป ให้บริการจัดส่งและจัดเลี้ยงทั่วประเทศไทย ทั้งกรุงเทพฯ ปริมณฑล ภาคกลาง ภาคตะวันออก ภาคอีสาน ภาคเหนือ และภาคใต้ โดยมีทีมรถครัวสัญจรพร้อมเดินทางไปบริการถึงหน้างานค่ะ',
    },
    {
      q: 'โปรโมชันสั่ง 20 โต๊ะ แถมฟรี 1 โต๊ะ มีเงื่อนไขอย่างไร?',
      a: 'โปรโมชันฉลอง 35 ปี เมื่อสั่งจองโต๊ะจีนตั้งแต่ 20 โต๊ะขึ้นไปในแพ็กเกจเดียวกัน ท่านจะได้รับโต๊ะแถมฟรีทันที 1 โต๊ะ (สั่ง 40 โต๊ะ แถมฟรี 2 โต๊ะ, 60 โต๊ะ แถมฟรี 3 โต๊ะ) โดยระบบ Smart Quotation Builder จะคำนวณส่วนลดโต๊ะแถมฟรีให้โดยอัตโนมัติค่ะ',
    },
    {
      q: 'สามารถสลับเปลี่ยนรายการอาหารในแต่ละจานได้หรือไม่?',
      a: 'สามารถสลับเปลี่ยนรายการอาหารในแต่ละหมวดหมู่ได้ฟรีตามรายการที่ระบุในระบบ Smart Quotation Builder หากต้องการเมนูพิเศษนอกเหนือจากรายการ สามารถแจ้งทีมงานเพื่อประเมินและจัดหาวัตถุดิบพิเศษให้ได้ค่ะ',
    },
    {
      q: 'เงื่อนไขการชำระเงินและเงินมัดจำอย่างไร?',
      a: 'ชำระเงินมัดจำ 30% ของยอดรวม เพื่อยืนยันล็อกคิววันจัดเลี้ยงและจัดเตรียมวัตถุดิบสด ส่วนยอดคงเหลือ 70% ชำระในวันจัดงานจริงหลังเสร็จสิ้นงานเลี้ยง โดยสามารถโอนผ่านบัญชีธนาคารไทยพาณิชย์ หรือสแกน Thai QR Payment ได้อย่างสะดวกค่ะ',
    },
    {
