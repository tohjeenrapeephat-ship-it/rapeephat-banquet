...
export const FAQSection: React.FC = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: 'ชำระเงินมัดจำ 30% ของยอดรวม เพื่อยืนยันล็อกคิววันจัดเลี้ยงและจัดเตรียมวัตถุดิบสด ส่วนยอดคงเหลือ 70% ชำระในวันจัดงานจริงหลังเสร็จสิ้นงานเลี้ยง โดยสามารถโอนผ่านบัญชีธนาคารหรือพร้อมเพย์ได้อย่างสะดวกครับ',
    },
    {
