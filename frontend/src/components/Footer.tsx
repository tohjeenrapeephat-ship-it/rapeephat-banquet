...
import { Phone, MessageCircle, MapPin, Award, Heart, Crown, Mail, ShieldCheck, FileText, Lock, CheckCircle2 } from 'lucide-react';
import { VisitorStatsSection } from './VisitorCounter.js';
import { PrivacyPolicyModal } from './PrivacyPolicyModal.js';
import { trackClickToCall, trackClickToLine } from '../utils/googleAnalytics.js';
    ...
    <>
      <footer className="bg-[#FFFDF9] text-slate-800 border-t-4 border-amber-400/80 pt-10 pb-16 sm:pb-8 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
            ...
            <div className="space-y-3">
              ...
              <div className="p-3 rounded-2xl bg-gradient-to-r from-amber-50/90 via-white to-amber-50/50 border border-amber-300 shadow-xs flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0 space-y-0.5">
                  ...
                  <a
                    href="tel:0813311646"
                    onClick={() => trackClickToCall('footer_coordinator_card')}
                    className="text-xs font-black text-red-700 hover:text-red-900 flex items-center gap-1 font-mono"
                  >
              ...
              <div className="flex flex-wrap items-center gap-2 pt-1 pb-1">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  onClick={() => trackClickToLine('footer_social_pills')}
          ...
          {/* Google Ads & Legal Compliance Links Bar */}
          <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-6 py-2 px-4 rounded-2xl bg-amber-50/50 border border-amber-200/70 text-xs font-bold text-slate-700">
            <button
              onClick={() => setIsPrivacyModalOpen(true)}
              className="hover:text-red-700 transition-colors flex items-center gap-1.5 cursor-pointer"
            >
              <Lock className="w-3.5 h-3.5 text-amber-700" />
              <span>นโยบายความเป็นส่วนตัว (Privacy Policy - PDPA)</span>
            </button>
            ...
            >
              ...
              <span>เงื่อนไขและข้อกำหนดการบริการ (Terms of Service)</span>
            </button>
            <span className="text-amber-300 hidden sm:inline">•</span>
            <button
              onClick={() => setIsPrivacyModalOpen(true)}
            ...
            >
              ...
              <span>นโยบายการจองและคืนเงินมัดจำ</span>
            </button>
          </div>
