                ...
                <div className="flex items-start gap-3.5">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      <span className="px-2 py-0.5 text-[8px] font-black uppercase tracking-wider bg-gradient-to-r from-emerald-600 to-teal-700 text-white rounded-full border border-emerald-300 shadow-2xs whitespace-nowrap">
                        RECEIPT
                      </span>
                    </div>
