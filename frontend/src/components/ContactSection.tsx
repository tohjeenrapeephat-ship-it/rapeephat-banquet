        ...
        <div className="space-y-6 pt-4">
          ...
          <div className="p-5 sm:p-6 rounded-3xl bg-gradient-to-r from-red-900 via-slate-900 to-red-950 text-white border-2 border-amber-400 shadow-xl text-center relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col sm:flex-row items-center justify-center gap-3">
              ...
              <p className="text-sm sm:text-base lg:text-lg font-bold text-amber-200 tracking-tight">
                &ldquo;เราพร้อมให้บริการจัดเลี้ยงโต๊ะจีนพรีเมียม ครอบคลุมพื้นที่กรุงเทพฯ ปริมณฑล ภาคกลาง และพื้นที่ใกล้เคียงอย่างไร้ขีดจำกัด&rdquo;
              </p>
            </div>
          </div>
        </div>
