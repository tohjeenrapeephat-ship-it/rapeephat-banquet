...
const LOCATIONS: LocationInfo[] = [
  {
    ...
    googleMapsUrl: 'https://maps.google.com/?q=ครัวรพีพัฒน์+โต๊ะจีน+รพีพัฒน์+72+หมู่+1+ตำบลนครปฐม+อำเภอเมืองนครปฐม+นครปฐม+73000',
    appleMapsUrl: 'https://maps.apple.com/?q=ครัวรพีพัฒน์+โต๊ะจีน+รพีพัฒน์+นครปฐม&address=72+หมู่+1+ตำบลนครปฐม+อำเภอเมืองนครปฐม+นครปฐม+73000',
  ...
  },
  {
    ...
    googleMapsUrl: 'https://maps.google.com/?q=50/8+หมู่+4+ถนนเลียบคลองสาม+ตำบลคลองสาม+อำเภอคลองหลวง+ปทุมธานี+12120',
    appleMapsUrl: 'https://maps.apple.com/?q=โต๊ะจีนรพีพัฒน์&address=50/8+หมู่+4+ถนนเลียบคลองสาม+ตำบลคลองสาม+อำเภอคลองหลวง+ปทุมธานี+12120',
